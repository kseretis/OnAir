...
public class Detail_Activity extends AppCompatActivity {
    ...
    private TextView refundable, seatsRemaining, OriginToDestination;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.simple_detail_activity);

        listView = (ListView) findViewById(R.id.listSimpleDetail);
        ...
        ListAdapter adapter = new SimpleAdapter(
                Detail_Activity.this, detailArrayListToGo,
                R.layout.detail_list, new String[]{
                ...
                new int[]{R.id.originD, R.id.LABEL_GO, R.id.departureTimeD, R.id.departuredayD, R.id.Marketing_airlineD, R.id.flight_number_and_aircraftD, R.id.travel_classD,
    ...
    *  Με Αυτήν την διαδικασία γλυτώνουμε χρόνο γιατι κάνει λιγότερα request*/
    ...
    public static class Detail_Activity_Return extends AppCompatActivity {
